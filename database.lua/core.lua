...
local addoninfo = 'AdiBags - Shadowlands Crafting - ' .. slc.ADDON_NAME.FilterTitle .. ' Version: ' .. version;
...
local options = {
	type = 'group',
	name = '-= |cffFFFFFF Shadowlands Crafting - ' .. slc.ADDON_NAME.FilterTitle .. '|r =-',
	inline = false,
	childGroups = "tab",
	args = {
		versionPull = {
...
local function MatchIDs_Init(self)
	...
	AddToSet(Result, slc.ADDON_NAME.database)
...
function setFilter:Filter(slotData)
	...
	if MatchIDs[slotData.itemId] then
		return N[slc.ADDON_NAME.FilterTitle]
	end
