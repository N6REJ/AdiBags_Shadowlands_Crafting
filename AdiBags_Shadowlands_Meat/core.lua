...
local addoninfo = 'AdiBags - Shadowlands Crafting - ' .. slc_meat.FilterTitle .. ' Version: ' .. version;
...
local options = {
	type = 'group',
	name = '-= |cffFFFFFF Shadowlands Crafting - ' .. slc_meat.FilterTitle .. '|r =-',
	inline = false,
	childGroups = "tab",
	args = {
		versionPull = {
...
local function MatchIDs_Init(self)
	...
	AddToSet(Result, slc_meat.database)
